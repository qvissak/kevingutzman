...
function Contact() {
  return (
    <div
      id="contact"
      className="mx-auto grid max-w-[1100px] grid-cols-[repeat(auto-fit,minmax(260px,1fr))] gap-10 px-[clamp(16px,4vw,32px)] pt-[clamp(28px,6vw,52px)] pb-[88px] scroll-mt-[60px]"
    >
      <div>
